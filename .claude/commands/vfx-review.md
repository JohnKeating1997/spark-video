...
1. Read `projects/$1/storyboard.json`.
2. Read `projects/$1/script.md`.
3. Read `projects/$1/lore.md` — note the `mood_anchor` string.
4. Read `projects/$1/cast.json`.
5. Run `./bin/videogen cast soul show --project $1`.
6. Run `./bin/videogen storyboard show --project $1` — note the Anchor column.
