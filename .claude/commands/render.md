...
1. Confirm storyboard validity: `videogen storyboard validate --project $1`.
2. Estimate wall-clock & cost; ask the user to confirm before kicking off.
3. Run `videogen render --project $1` — this is sequential and may take 30–90 min.
...
5. After all shots succeed, run `videogen stitch --project $1`.
6. Tell the user where the final mp4 is, plus how to re-render any single shot
   with `videogen render --project $1 --shot <id> --force`.
