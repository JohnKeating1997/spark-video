...
### Step 6 — GATE 2: storyboard.json + static storyboard panels
...
image contains 2-3 comic-style panels covering consecutive shots. This
is the cheap visual approval gate before expensive video rendering.

Wait for approval of both the storyboard breakdown and the static
panels. If approved:
